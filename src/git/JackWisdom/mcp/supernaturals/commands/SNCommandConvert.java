...
/*  56 */         String superType = this.parameters.get(1).toUpperCase();
...
/*  72 */         if (snplayer.getType().name()==superType ) {
...
/*     */ 
/*     */         }
/*  78 */         else if (snplayer.getOldType().name().equalsIgnoreCase(superType)) {
...
/*     */ 
/*     */ 
/*  91 */           SuperNManager.convert(snplayer, SuperType.valueOf(superType));
/*     */         }
/*     */       }
/*  94 */       return;
/*     */     }
...
/*  99 */       if (!senderPlayer.hasPermission( permission2)) {
/* 100 */         sendMessage(Language.NO_PREMISSION.toString());
/* 101 */         return;
/*     */       }
/* 103 */       String superType = ( this.parameters.get(0)).toLowerCase();
/*     */       
...
/* 111 */       if (snplayer.getType().name().equalsIgnoreCase(superType)) {
...
/*     */ 
/*     */       }
/* 117 */       else if (snplayer.getOldType().name().equalsIgnoreCase(superType)) {
...
/*     */ 
/*     */ 
/* 130 */         SuperNManager.convert(snplayer, SuperType.valueOf(superType));
/*     */       }
/*     */     }
/*     */     else {
/* 134 */       if (!senderPlayer.hasPermission( this.permissions)) {
...
/* 154 */       if (snplayer.getType().name().equalsIgnoreCase(superType)) {
...
/*     */ 
/*     */       }
/* 160 */       else if (snplayer.getOldType().name().equalsIgnoreCase(superType)) {
