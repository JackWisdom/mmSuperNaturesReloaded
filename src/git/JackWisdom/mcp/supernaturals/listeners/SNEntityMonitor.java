...
/*  66 */         if ((!player.hasPermission(worldPermission)) && (SNConfigHandler.multiworld))
/*     */         {
/*     */ 
/*  69 */           return;
/*     */         }
/*  71 */         HunterManager.ArrowType arrowType = this.plugin.getHunterManager().getArrowMap().get(arrow);
/*     */         
/*  73 */         if (arrowType== HunterManager.ArrowType.TRIPLE) {
/*  74 */           player.teleport(arrow.getLocation());
/*  75 */         } else if (arrowType==HunterManager.ArrowType.FIRE) {
...
/* 175 */       (pDamager != null)) {
/* 176 */       if ((!pDamager.hasPermission(this.worldPermission)) && (SNConfigHandler.multiworld))
/*     */       {
/* 178 */         return;
/*     */       }
...
/*     */     
/* 192 */     if ((!pVictim.hasPermission(this.worldPermission)) && (SNConfigHandler.multiworld))
/*     */     {
/* 194 */       return;
/*     */     }
/*     */     
