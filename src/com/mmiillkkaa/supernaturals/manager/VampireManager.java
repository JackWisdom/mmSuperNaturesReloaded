...
/*     */         
/* 143 */         SuperNManager.convert(victim, "vampire");
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */     
/*     */ 
/* 361 */     if (!SupernaturalsPlugin.hasPermissions(player, "supernatural.player.shrineuse.vampire"))
/*     */     {
...
/* 402 */       SuperNManager.convert(snplayer, "vampire", SNConfigHandler.vampirePowerStart);
/*     */     }
/*     */     else {
...
/*     */     
/*     */ 
/* 448 */     if (!SupernaturalsPlugin.hasPermissions(player, "supernatural.player.shrineuse.vampire"))
/*     */     {
...
/*     */     
/* 529 */     if (SupernaturalsPlugin.hasPermissions(player, this.permissions)) {
/* 530 */       return false;
/*     */     }
/*     */     
