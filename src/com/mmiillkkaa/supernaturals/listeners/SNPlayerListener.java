...
/*     */     }
/*     */     
/*  70 */     if ((!SupernaturalsPlugin.hasPermissions(player, this.worldPermission)) && (SNConfigHandler.multiworld))
/*     */     {
/*  72 */       return;
/*     */     }
/*     */     
...
/*     */     }
/*     */     
/* 188 */     if ((!SupernaturalsPlugin.hasPermissions(event.getPlayer(), this.worldPermission)) && (SNConfigHandler.multiworld))
/*     */     {
/* 190 */       return;
/*     */     }
/*     */     
