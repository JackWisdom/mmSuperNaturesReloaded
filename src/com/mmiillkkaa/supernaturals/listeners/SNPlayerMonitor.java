...
/*  98 */       return;
/*     */     }
/* 100 */     if ((!SupernaturalsPlugin.hasPermissions(player, this.worldPermission)) && (SNConfigHandler.multiworld))
/*     */     {
/* 102 */       return;
/*     */     }
...
/* 113 */     if ((!SupernaturalsPlugin.hasPermissions(event.getPlayer(), this.worldPermission)) && (SNConfigHandler.multiworld))
/*     */     {
/* 115 */       return;
/*     */     }
...
/*     */     
/*     */ 
/* 123 */     if (SupernaturalsPlugin.hasPermissions(player, "supernatural.admin.infinitepower"))
/*     */     {
